...
function CheckOut() {
  ...
  function handleOrder() {
    if (selectAddress && paymentMethod) {
      const order = {
        ...
        selectAddress,
        paymentMethod,
        status: "pending", // other status can be
      };
  ...
  return (
    <>
      {!itemset.length && <Navigate to={"/"}></Navigate>}
      {currentOrder && (
            ...
            <div className="mx-auto mt-12 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
                          ...
                          <div className="flex flex-1 items-end justify-between text-sm">
                            ...
                            <div className="flex">
                              <button
                                ...
                                onClick={(e) => {
                                  dispatch(
                                    deleteItemFromCartAsync(itemdata.id)
                                  );
                                }}
                              >
                                Remove
              ...
              <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                ...
                <div className="mt-6">
                  <div
                    onClick={handleOrder}
                    className="flex items-center justify-center cursor-pointer rounded-md border border-transparent bg-rose-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-rose-700"
                  >
                    Order Now
                  </div>
                </div>
