...
export default function UpdateProductForm() {
  ...
  const productById = useSelector(selectedProductById);
  ...
  return (
    <>
      {productUpdated && <Navigate to={"/admin"} replace={true}></Navigate>}
      {productById && (
        <form
        ...
        >
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              {productById.deleted && (
                <h2 className="my-4 text-2xl font-bold leading-7 text-red-600">
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2">
                    <select
                      ...
                      className="block w-full rounded-md border-0 px-2login py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:max-w-xs sm:text-sm sm:leading-6"
                    >
          ...
          <div className="mt-6 flex items-center justify-end gap-x-6">
            <button
              type="button"
              className="rounded-md bg-slate-200 px-3 py-2 text-sm text-gray-900 font-semibold shadow-sm hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-600"
              onClick={() => setProductUpdated(true)}
            >
              Cancel
            </button>
            {!productById.deleted && (
